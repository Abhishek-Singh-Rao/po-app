  ...
  return Controller.extend("com.ycl.purchaseorder.controller.Detail", {
    ...
    _onObjectMatched: function (oEvent) {
      ...
      // EXISTING FLOW
        ...
        // Bind fresh context with refresh and only expand Company, Vendor, DocumentType
        oView.bindElement({
        ...
        // Recalculate total amount after data loads
    ...
    _onCreateMatched: function () {
      ...
      if (oTable) {
        Promise.resolve().then(() => {
          oTable.bindItems({
            path: "Items", // relative to the transient context
            template: oTable.getBindingInfo("items").template,
            templateShareable: true
          });
        }, 0);
